...
$default_serial = 100;
$max_serial_res = mysql_query("SELECT `file_serial` FROM tbl_chancellor ORDER BY `file_serial` DESC LIMIT 1");
			...
			<td>
				<table width="100%" border="0" cellpadding="5" cellspacing="1" class="small">
					<tr align="left" valign="top" bgcolor="#FFFFFF">
						<td width="30%"><span class="style2"><span class="subHead">校長的話</span>：</span>&nbsp;</td>
            ...
            <input name="n_serial" type="text" size="10" maxlength="10" value="100">
						...
						KindEditor.options.filterMode = false;
						        KindEditor.ready(function(K) {
						                window.editor = K.create('#n_content',{afterBlur: function(){this.sync();}});
						        });
						</script>
