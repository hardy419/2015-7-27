...
<div id="content">
        ...
        <div class="left_side_content">
            <div class="left_side_content_in">
              <table width="176" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><a href="school_intro.php" target="_self"><img src="images/left_hover_03.jpg" border="0"/></a></td>
                </tr>
                <tr>
    ...
    <div class="right_side">
        ...
        <table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left"><img src="images/school_right_top_77.jpg" /></td>
            <td align="right" class="12pxfont"><table border="0" cellspacing="0" cellpadding="0"  class="position email_hover">
              <tr>
                ...
                <td width="25" align="center">&gt;</td>
                <td align="left" height="25">學校介紹</td>
              </tr>
              <tr>
                ...
                <td width="25" align="center">&gt;</td>
                <td align="left" height="20">School Background</td>
              </tr>
            </table></td>
          </tr>
        </table>
          ...
          <table width="745" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left" valign="top"><table width="745" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div class="main_title"><img src="images/about_001.jpg" width="743" height="35" /></div>
           <div class="detail_content"><img src="images/about_003.jpg" width="232" height="161"  class="allimg_border"/>
           <p>本校為一所全日制政府津貼中學，與金巴崙長老會耀道小學結龍，為六年平行班級制的千禧中學(每級四班，共六級)，於2005學年開辦中一級。我們的抱負是培育有情、有夢、有學養、有技術、適應能力高的新一代人才，成為香港的領袖及各方面的專才，面對香港社會發展的種種挑戰。</span></p>
           <div class="clear"></div></div>
           <div class="main_title"><br />
                 <img src="images/about_002.jpg" width="743" height="35" /></div>
           <div class="detail_content"><img src="images/about_004.jpg" width="232" height="161"  class="allimg_border"/>
           <p>本校初中課程除了提供中文、英文、數學、科學、人文、體育、中國歷史、基督教教育、電腦與科技、視覺藝術、食物及營養、普通話及音樂科外，亦提供綜合能力訓練及專題學習，建立學生的學習能力。</p>
