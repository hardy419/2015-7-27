    ...
    <div class="right_side">
        <div class="right_side_top02">
          <table width="780" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left"><img src="images/contact_03.jpg" /></td>
		...
		</div><!--right_side_top02-->          <table width="100%" border="0" cellspacing="0" cellpadding="0">			<tr>				<td colspan='2'	>&nbsp;</td>			</tr>			<tr>				<td colspan='2'	>&nbsp;</td>			</tr>			<tr>				<td colspan='2' align='right'>					<a href='javascript:;' style='position:relative;margin:0 5px;line-height:20px;' onclick='javascript:history.go(-1);'>						<img style='position:relative;top:-2px;line-height:20px;margin:0px 5px;' src="images/arrow.jpg" width="4" height="10" /> 返回 					</a>					<a href="javascript:MM_openBrWindow('./pop_email.php?title=登錄','view','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=350,top=50,left=50')" style='line-height:20px;'>						<img style='line-height:20px;' src="./images/email.gif" border="0" style="margin-bottom:-3px;"> <font style="font-size:12px;">電郵本頁</font>					</a>				</td>			</tr>			<tr>				<td colspan='2'	>&nbsp;</td>			</tr>		</table>
		<div class='main_login'>
			...
			<div class='main_loginBox'>
				...
				<form action='./model/do_login.php' method='post' id='form_login' name='form_login'>
					<table class='tb_login' cellpadding='5'>
						...
						<tr>
							...
							<td><input type='text' name='u_name' id='u_name' class='ipt_txt_login' maxlength='20' style="height:25px;"/></td>
						</tr>
						<tr>
							<td>密碼<span class='right'>：</span></td>
							<td><input type='password' name='u_pwd' id='u_pwd' class='ipt_txt_login' maxlength='20' style="height:25px;"/></td>
						</tr>
						<tr>
...
<script>
	if(<?php echo $_GET['msg'];?> == 101){
		$("#error_box").append("驗證碼輸入錯誤！");
		$("#error_box").fadeIn(200);
	}else if(<?php echo $_GET['msg'];?> == 102){
