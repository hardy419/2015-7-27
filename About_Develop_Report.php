...
//**************  Paging System - Start ************/
$search_SQL    = "SELECT    *    FROM     tbl_down   WHERE  a_type=1 order by  `order` desc ";
$report_Result = mysql_query( $search_SQL, $link_id );

$search_SQL    = "SELECT    *    FROM     tbl_down   WHERE  a_type=2 order by  `order` desc ";
$order_Result = mysql_query( $search_SQL, $link_id );

$search_SQL    = "SELECT    *    FROM     tbl_down   WHERE  a_type=3 order by  `order` desc ";
 ...
 &gt; 						</li>
	  ...
	  <div id="contents_In">
	    <table width="98%" border="0" cellspacing="0" cellpadding="10">
          <tr>
            <td width="81%" valign="top" class="section"><table width="100%" border="0" cellpadding="8" cellspacing="1">
              <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E8CE">
                <tr>
                  <td height="40" colspan="2" align="left" bgcolor="#EDF2D8" class="section" style="padding-left:2.5%;"><strong>報告</strong></td>
                </tr>
                 <?php
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E8CE">
                <tr>
                  <td height="40" colspan="2" align="left" bgcolor="#EDF2D8" class="section" style="padding-left:2.5%;"><strong>計劃書</strong></td>
                </tr>
                <?php
