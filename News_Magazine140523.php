            ...
            <td colspan="3" class="section"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E8CE">
              <tr>
                ...
                <td height="40" align="center" bgcolor="#EDF2D8"><strong>日期</strong></td>
					...
					?>
			 <tr>
                 <td height="35" align="center" bgcolor="#FFFFFF"><a href="<?php if(is_file(file_Path.$Report_Obj->down_file))echo file_Path.$Report_Obj->down_file;else echo "javascript:void(0);"?>" target="_blank"><?php echo $Report_Obj->a_title;?> </td>
