...
$search_SQL    = "Select ta.*,tt.* FROM `tbl_activity` AS ta left JOIN (select * from tbl_activity_gallery group by act_id)  AS tt  ON ta.id=tt.act_id";
...
</style><body><?php include('top_news.php'); ?>
      ...
      <div id="contents">
	     ...
	     <!-- locationGroup -->
	      <div id="locationGroup">
            <img src="images/title/info_act_photos.jpg" />
 ...
 &gt; 						</li>
	  ...
	  <div id="contents_In">
          ...
          <tr>
			...
			?>
                    <li>
                      <a class="img" href="News_Photo_List.php?id=<?php echo $get_rows['id'];?>"><img  src="gallery_activity/web<?php echo $get_rows['ori_file_name'];?>" /></a>
                      <a class="link" href="News_Photo_List.php?id=<?php echo $get_rows['id'];?>"><?php echo sub_str($get_rows['name'],16);?></a>
