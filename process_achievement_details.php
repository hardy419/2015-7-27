...
<div id="content">
    ...
    <div class="right_side">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="15%" align='right'>
					<?php show_get_back('process_achievement.php','返回上一級'); ?>
		...
		<script>
			...
			<div class='details_Top_Box_warp' >
				<table width="740" height="35" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="530" valign="middle" background="images/detail_center.jpg" bgcolor="#5B7BB6"><h2 style="font-size:14px;color:#fff; font-family:Verdana, Arial, Helvetica, sans-serif"><?php echo $res_arr_details['title_cn'];?></h2></td>
                    <td width="23" valign="top" bgcolor="#5B7BB6"><img src="images/detail_right.jpg" width="23" height="35" /></td>
                    <td width="164" align="right" background="images/detail_center_line.jpg"><?php echo $res_arr_details['date'];?></td>
                  </tr>
                </table>
			...
			<!--div class='details_Top_Box_warp'>
				<h2 class='details_h2'><?php echo $res_arr_details['title_cn'];?></h2>
				<span class='details_span'>日期：<?php echo $res_arr_details['date'];?></span>
				<?php if(!empty($res_arr_details['description'])){ ?>
				<div class='details_descriptionBox'>简介：<?php echo $res_arr_details['description'];?></div>
				<?php } ?>
			</div><!--details_Top_Box_warp-->
			<?php if($get_result_photo){ ?>
			...
			<?php } ?>
			<!--老版显示div class='details_top_box2' >
			...
			<br/>
			<br/>
			<div class='Process_details'><?php echo $res_arr_details['description'];?></div老版显示-->
		</div><!--right_content-->
    </div> 
</div>
