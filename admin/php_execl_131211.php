...
?>
<table width="60%" border="0" cellpadding="10" cellspacing="1" class="small" bgcolor="#CCCCCC">
                        <tr>
  
                          <td width="85%" bgcolor="#FFFFFF" align="center">網上報名導出系統 <a href="apply/apply_result.php?id=<?=$_GET["id"]?>" target="admin_main">返回</a></td>
                        </tr>
                        <tr>
 
                          <td width="85%" bgcolor="#FFFFFF" align="center"><?php echo("<a href='phpexecl/apply".$cancel_time.$_GET["id"].".xls' mce_href='phpexecl/apply".$cancel_time.$_GET["id"].".xls'>点击下载報名學生</a>"); ?>    </td>
                        </tr>
      </table>
</body></html>