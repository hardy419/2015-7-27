...
// calendarid post_id poster date title content posttime 
	...
	if (isset($_FILES["cover_Photo"]["tmp_name"])&&$_FILES["cover_Photo"]["tmp_name"]!=""){
		...
		image_resize($_FILES["cover_Photo"]["tmp_name"],$new_file_name_cover,$oldfilename_cover."original/",$size[0],$size[1],120);
		image_resize($_FILES["cover_Photo"]["tmp_name"],$new_file_name_cover,$oldfilename_cover,225,171,120);
