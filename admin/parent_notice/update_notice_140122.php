...
&nbsp;<font color=red>(你目前而上載檔案
      ...
      <? } ?>
          <p style='color:red;'>(家校園地與影片庫專用 建議圖片大小230*159)</p></td>
        </tr>
		<tr>
		...
		<div style='width:200px;'>
			<table border="0" cellpadding="5" cellspacing="0">
				...
				<tr>
					...
					<td>如想新增或修改影片庫連接，請將影片連接填寫至「相關連結網址」,影片名稱填寫至「相關連結名稱」,圖片添加至封面圖片即可</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan='2'><span style='color:#0000FF;'>傑出成就：</span></td>
				</tr>
				<tr>
					<td valign='top'><span style='color:red;'>*</span></td>
					<td>前臺"描述"內容可在"描述"中填寫</td>
				</tr>
			</table>
		</div>
	  </td>
