  ...
  <table width="850" border="0" cellpadding="5" cellspacing="0" class="table1">
    <tr> 
      <td  valign="top"> <table width="100%"  border="0" align="left" cellpadding="10" cellspacing="1" bgcolor="CCCCCC">
        <tr bgcolor="ECECEC">
          <td colspan="2" bgcolor="ECECEC" class="subHead">更改事件</td>
        </tr>
        <tr>
		  ...
		  <select name="child_type" id="child_type" style='display:none;'>
            ...
            <option value="4" <? if ($get_rows["doc_child_type"]=="4") { echo "selected"; } ?>>周年計劃</option>
        ...
        <tr>
          <td width="118" height="25" bgcolor="ECECEC"><font class="style8">&nbsp;編號 :</font></td>
...
&nbsp;<img src="../../images/calendar.gif" alt="calendar" border="0" onClick="showCalendar('date_year2','date_day2','date_month2','date_year2','d m y')">&nbsp; DD-MM-YYYY</font></td>
        ...
        <tr>
          ...
          <td height="18" valign="top" bgcolor="FFFFFF"><input type="file" name="file">
              <br>
...
&nbsp;<font color=red>(你目前而上載檔案
      ...
      <a href="?year=<?=$_GET[year]?>&month=<?=$_GET[month]?>&id=<?=$_GET[id]?>&Dfile=2" class="style8">刪除檔案</a> )</font>
      <? } ?>
          <p style='color:red;'>(家校園地專用)</p></td>
        </tr>
		<tr>
...
/*
$doc_Year = substr($get_rows[date], 0,4)|0;
$doc_Month = substr($get_rows[date], 5,2)|0;
$start_Year = $doc_Year+2;
$end_Year = 2000;

for( $i=$start_Year; $i>=$end_Year; $i-- )
{
	if( ($i==$doc_Year && $doc_Month>=9) || ($i==$doc_Year-1 && $doc_Month<=8) )
