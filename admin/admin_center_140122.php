    ...
    <TD align="left" valign="top">請選擇下列項目 </td>
        ...
        <tr> 
          <td valign="top" bgcolor="#ECECEC" ><TABLE width="90%" border="0" align="center" cellpadding="5" cellspacing="0">
			...
			<TR>
			  <TD align="left" valign="top"><a href="calender/calendar.php?type=S" target="admin_main">最新消息</a> </td>
			  </tr>
			<TR>
			  <TD align="left" valign="top"><a href="calender/calendar.php?type=S&show_banner=1&hi_ST=L" target="admin_main">焦點消息（主頁Banner管理）</a> </td>
			  </tr>
			<TR>
