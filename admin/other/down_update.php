...
if ($_GET[Dfile] == 1 )
{
	...
	$sql = "SELECT * FROM `tbl_other` WHERE a_id=$a_id ";
...
$get_sql = "Select * FROM   tbl_other  WHERE    tbl_other.a_id=".$a_id;
...
<p class="title">其他作品</p><BR>
<table width="650" border="0" cellpadding="10" cellspacing="1" class="small">
        <tr align="left" valign="top" bgcolor="#FFFFFF">
          <td width="30%" height="35"><span class="style2"><span class="style4">其他作品管理</span>：</span></td>
...
<table width="650" border="0" cellpadding="5" cellspacing="1">
  <tr >
    <td width="100%" ><br>
      ...
      <tr valign="top">
        <td colspan="4" bgcolor="ECECEC"><font class="style4">更改其他作品資料</font> </td>
        </tr>
