    ...
    <td>
            ...
            <td width="85%" bgcolor="#FFFFFF"><table border="0" cellpadding="1" cellspacing="0" class="small">
                <tr>
                  ...
                  <select name="a_type" id="a_type">
                        ...
                        <option value="1" <?php if($_GET["a_type"]==1){echo "selected";}?>>通告下載</option>
                        <option value="2" <?php if($_GET["a_type"]==2){echo "selected";}?>>校園刊物</option>
                        <option value="3" <?php if($_GET["a_type"]==3){echo "selected";}?>>招標公告</option>
                        <option value="4" <?php if($_GET["a_type"]==4){echo "selected";}?>>學校報告及發展計劃</option>
                         <option value="5" <?php if($_GET["a_type"]==5){echo "selected";}?>>傳媒報道</option>
                         <option value="6" <?php if($_GET["a_type"]==6){echo "selected";}?>> 境外學習活動</option>
                </select>
            </td>
      ...
      <table width="100%"  border="0" cellpadding="10" cellspacing="1" bgcolor="CCCCCC">
        <tr valign="top" bgcolor="ECECEC" > <td width="8%" nowrap class="admin_maintain_header">序號</td>
          ...
          <td width="12%" nowrap class="admin_maintain_header">類別</td> 
	...
	echo $str_key;
      ...
      ?>
        <tr align="left" valign="top" > <td nowrap bgcolor="#FFFFFF" ><font class="style8"> 
          ...
          <td nowrap bgcolor="#FFFFFF" ><?php if($get_rows["a_type"]==1){echo "通告下載";}elseif($get_rows["a_type"]==2){echo "校園刊物";}elseif($get_rows["a_type"]==3){echo "招標公告";}elseif($get_rows["a_type"]==4){echo "學校報告及發展計劃";}elseif($get_rows["a_type"]==5){echo "傳媒報道";}else{echo "境外學習活動";}?></td>
