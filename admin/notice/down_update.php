...
if ($_GET[Dfile] == 1 )
{
	...
	$sql = "SELECT * FROM `tbl_notice` WHERE a_id=$a_id ";
	$result = mysql_query($sql,$link_id); 
	$get_rows = mysql_fetch_array($result);

}

$get_sql = "Select * FROM   tbl_notice  WHERE    tbl_notice.a_id=".$a_id;
...
<table width="850" border="0" cellpadding="5" cellspacing="1">
  <tr >
    <td width="100%" ><br>
      ...
      <tr valign="top">
        <td colspan="4" bgcolor="ECECEC"><font class="style4">更改<?php echo $topic;?>資料</font> </td>
        </tr>
          ...
          <tr>
			...
			KindEditor.options.filterMode = false;
			        KindEditor.ready(function(K) {
			        	 window.editor = K.create('#a_content',{ afterBlur: function(){this.sync();}});
			        });
			</script>
                    <textarea name="a_content" id="a_content" cols="60" style="width: 670px; height: 300px;"><?php echo $get_rows["a_content"]?></textarea>
