...
$sql = "select * from tbl_w_content where w_id = '$w_id'";

$result = mysql_query($sql);

$rs_obj = mysql_fetch_object($result);

$order = $rs_obj->type_order;

$type_id = $rs_obj->w_type_id;

$date = $rs_obj->w_date;

$title = $rs_obj->w_title;

$content = $rs_obj->w_description;

$linl_url = $rs_obj->link_url;

$link_text = $rs_obj->link_text;
		...
		<tr>
			...
			<td valign="top">
				...
				<table width="100%" border="0" align="left" cellpadding="10" cellspacing="1" bgcolor="CCCCCC" class="admin_maintain_form_table">
					...
					<form name="form1" method="post" action="w_update_process.php" enctype="multipart/form-data" onSubmit="return Submit_Form()">
...
?>
        ...
        <tr bgcolor="FFFFFF">
          ...
          <td width="71%" height="18"><font class="style8">
            ...
            <input name="n_serial" type="text" size="10" maxlength="10" value="<?php   echo $order;?>">
...
<input name="date_year" type="text" size="4" maxlength="4" class="style8" value="<?php echo substr($date, 0,4)?>">

 - 

<input name="date_month" type="text" size="2" maxlength="2" class="style8" value="<?php echo substr($date, 5,2)?>">

 - 

<input name="date_day" type="text" size="2" maxlength="2" class="style8" value="<?php echo substr($date, 8,2)?>">
 ...
 &nbsp;<img src="../../images/calendar.gif" alt="calendar" border="0" onClick="showCalendar('date_year','date_day','date_month','date_year','d m y')">&nbsp; YYYY-MM-DD </font></td>
						...
						<tr>
							...
							<td height="18" bgcolor="FFFFFF"><font class="style8"> <input type="text" name="n_title" id="n_title" value="<?php   echo $title;?>" size="40"> </font></td>
						...
						<tr>
							...
							<td height="18" bgcolor="FFFFFF">
								...
								<textarea name="n_content" id="n_content" cols="38" rows="5" ><?php   echo $content;?></textarea></td>
						...
						<tr bgcolor="FFFFFF">
							...
							<td height="18"><input name="n_link_text" type="text" id="n_link_text" size="40" value="<?php   echo $link_text;?>"></td>
						...
						<tr bgcolor="FFFFFF">
							...
							<td height="18"><input name="n_link_url" type="text" id="n_link_url" value="<?php   echo $linl_url;?>" size="40"></td>
						...
						<tr>
							...
							<td height="18" bgcolor="FFFFFF"><input type="file" name="n_file" id="n_file">
...
if( $file_name!='' && file_exists("../../file_download/".$file_name) )

{

	echo '<BR><font color=red>(你目前已上載檔案 <a href="n_delete.php?id='. $file_id .'&action=2" onClick="return confirm(\'你確定要刪除這檔案嗎?\')" >刪除檔案</a> )</font><BR><a href="../../file_download/'.$file_name.'" target="_blank">下載</a>';
...
?></td>
						...
						<tr bgcolor="ECECEC">
							...
							<td><font class="style8"><input type="hidden" name="w_id" id="w_id" value="<?php echo $w_id?>"></font></td>
						  ...
						  <input type="reset" value="重設"> &nbsp; <input type="button" onClick="history.go(-1)" value="返回"></font></td>
