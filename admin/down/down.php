...
<table width="650" border="0" cellpadding="10" cellspacing="1" class="small">
        <tr align="left" valign="top" bgcolor="#FFFFFF">
          <td width="30%" height="35"><span class="style2"><span class="style4">通告下载管理</span>：</span></td>
...
?>
  <tr> 
    <td>
      ...
      <table width="100%"  border="0" cellpadding="10" cellspacing="1" bgcolor="CCCCCC">
        <tr valign="top" bgcolor="ECECEC" > 
          <td width="36%" nowrap class="admin_maintain_header"><a href="aboutus.php?<?php   echo "orderby=a_title&seq=";
          if($orderby=="a_title"){
	...
	echo $str_key;
          ?>">標題</a></td>
          <td width="44%" nowrap class="admin_maintain_header">序號</td>
