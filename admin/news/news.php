...
$get_sql = "Select * FROM `tbl_news`   WHERE 1 ";

if($t_name != "")
	$get_sql .= " and a_title LIKE '%" . $t_name. "%'";

if($orderby!="")
	$get_sql .= " ORDER BY tbl_news.".$orderby." ".$orderseq;
...
<!-- <table width="650" border="0" cellpadding="10" cellspacing="1" class="small">
        <tr align="left" valign="top" bgcolor="#FFFFFF">
          <td width="30%" height="35"><span class="style2"><span class="style4">學校資訊管理</span>：</span></td>
          <td width="20%"><a href="news_add.php">新增</a></td>
          <td width="20%">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
      </table> -->
    ...
    <td>
      ...
      <table width="100%"  border="0" cellpadding="10" cellspacing="1" bgcolor="CCCCCC">
        <tr valign="top" bgcolor="ECECEC" > <td width="12%" nowrap class="admin_maintain_header">序號</td>
          <td width="36%" nowrap class="admin_maintain_header"><a href="news.php?<?php   echo "orderby=a_title&seq=";
          if($orderby=="a_title"){
      ...
      ?>
        <tr align="left" valign="top" >  <td nowrap bgcolor="#FFFFFF" ><font class="style8"> 
         ...
         <!--  <td nowrap bgcolor="#FFFFFF" ><?php if($get_rows["contype"]==2){echo "資訊類型";}elseif($get_rows["contype"]==3){echo "下載類型";}else{echo "單頁類型";}?></td> -->
          <td nowrap bgcolor="#FFFFFF" ><?php if($get_rows["contype"]==2){echo "<a href='n_search.php?type=$get_rows[a_type]'>管理</a>";}elseif($get_rows["contype"]==3){echo "<a href='down.php' >管理</a>";}else{echo "<a href='news_update.php?id=".$get_rows["a_id"]."'>管理</a>";}?></td>
          <td align="center" nowrap bgcolor="#FFFFFF" ><font class="style8" color="#0000FF"><a href="news_update.php?id=<?php echo $get_rows["a_id"]?>"><img src="../icons/xie.gif" width="16" height="16" border=0 alt=更改及檢視></a></font></td>
         <!--  <td align="center" nowrap bgcolor="#FFFFFF" ><font class="style8" color="#0000FF"><a href="news_delete.php?id=<?php echo $get_rows["a_id"]?>&fn=<?php echo $get_rows["docoment_name"]?>" onClick="return confirm('你確定要刪除這筆資料嗎?')"><img src="../icons/del.gif" alt="刪除" width="16" height="16" border="0"></a></font></td> -->
        </tr>
        <?php   } ?>
