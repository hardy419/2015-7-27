...
if ($_GET[Dfile] == 1 )
{
	...
	$sql = "SELECT * FROM `tbl_news` WHERE a_id=$a_id ";
	$result = mysql_query($sql,$link_id); 
	$get_rows = mysql_fetch_array($result);

}

$get_sql = "Select * FROM   tbl_news  WHERE a_id=".$a_id;
...
<p class="title">學校資訊</p><BR>
   <form method="post" name="update_user" action="news_update_process.php" onSubmit="return check_valid();" enctype="multipart/form-data">
