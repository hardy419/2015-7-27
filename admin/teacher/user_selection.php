...
$get_sql = "Select * FROM `tbl_teacher`  LEFT JOIN  tbl_teacher_type ON ( tbl_teacher.type_id=tbl_teacher_type.id )   WHERE 1 ";
...
if($t_name != "")
	...
	$get_sql .= " and teacher_name LIKE '%" . $t_name. "%'";
...
if($orderby!="")
	...
	$get_sql .= " ORDER BY tbl_teacher.".$orderby." ".$orderseq;

else

	$get_sql .= " ORDER BY   tbl_teacher_type.type_order  ASC,  tbl_teacher.order  ASC  ";
