        ...
        <form method="POST" name="add_link" action="link_update_process.php?action=update" onSubmit="return check_valid();" enctype="multipart/form-data">
		 ...
		 <tr>
          ...
          <tr>
            ...
            <td height="18" colspan="3" bgcolor="FFFFFF"><input name="link_address" id="link_address" type=text class="style8" size="40" value="<?php echo $link_address; ?>">格式：http://www.abc.com</td>
         ...
         <input name="link_pic1" type="text" id="link_pic1" size="25" value="<?php echo $link_logo; ?>"><input type="button" size="20" value="瀏覽文件" onClick="document.add_link.link_logo.click();"><?php if($link_logo!=""){?><br><img src="../../userfiles/upload/<?php echo $link_logo; ?>" height="68" width="180" /><?php }?></td>
