        ...
        <tr> 
          <td class="style3"><div align="left">
            <table width="100%"  border="0" align="left" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC" class="small">
               <form method="POST" name="form1" action="activity_add_process.php" onSubmit="return check_valid();" enctype="multipart/form-data">
			  <tr>
...
<?PHP } else if (1 == $type) { ?>
              <tr class="tr-title" valign="top" bgcolor="#FFFFFF">
                <td height="18">&nbsp;標題:</td>
                <td height="18"> <input name="participant" type="text" class="style8" id="participant" size="40" value="" ></td>
              </tr>
              <tr class="tr-date" valign="top" bgcolor="#FFFFFF">
                <td height="18">&nbsp;日期:</td>
                <td height="18">
