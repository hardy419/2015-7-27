<?
    ...
    */
    ...
    $get_sql = "Select * FROM `tbl_activity` WHERE 1";

    if ($_GET[t_name] != ""){
		$get_sql .= " and name LIKE '%" . $_GET[t_name]. "%' OR category LIKE '%" . $_GET[t_name]. "%'"; 
    }
	...
	if(isset($_GET['id']) && !empty($_GET['id'])){
		$get_sql = 'Select * FROM `tbl_activity` WHERE id = \''.$_GET['id'].'\'';
	}
