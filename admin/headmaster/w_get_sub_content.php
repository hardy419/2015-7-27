...
$show_sub_content_sql = "SELECT * FROM    tbl_web_sub_content    WHERE         web_sub_content_id!=".$sub_content_ID."   AND    web_sub_content_inner=0      AND    web_content_id=". $HeadMaster_WebContent_ID ."  AND    web_content_id=". $content_ID;
