...
if( $name != "" )
{
	...
	// Insert new data
	$add_sql = " INSERT INTO `tbl_movie` ( `date` , `year` , `name` , `description` , `modified_by` , `modified_date`, `type_id`, `class_year` )
 VALUES ($sql_date, $year, '$name', '$desc', '".$_SESSION["plk_admin_user_name"]."', now(), $type_id, $class_year ) ";
