...
<body><table width="60%" border="0" cellpadding="10" cellspacing="1" class="small" bgcolor="#CCCCCC">
    ...
    <table align="center" width="90%" border="0">
      <tr>
         <td><input type="file" name="inputExcel" id="inputExcel" ><input type="submit" value="導入數據"></td>
      </tr>
    </table>
</form>  </td>
                        </tr>
...
$i=1;
    foreach($indata as $item){
       ...
       if($i>2){
        $sql = "insert into tbl_apply_form_submit(`post_id`,`name_chi`,`name_eng`,`sex`,`tel`,`email`,`special_question_1`,`special_question_2`,`remark`,`DateTime`) values('$post_id','$item[0]','$item[1]','$xb','$item[3]','$item[4]','$item[5]','$item[6]','$item[7]','$item[8]')";
        mysql_query($sql);}
		$i++;
    }
