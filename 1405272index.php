...
banner_list{width:1100px; height:545px; overflow:hidden;}
#banner_list .bannerbox{position:relative;width:1100px; height:545px; }
.bannerbox a img{height:545px; width:1100px;}
.bannerbox .word{position:absolute; z-index:2;left:40px;top:267px;}
.bannerbox .people{ position: absolute; z-index:3;}
...
$(document).ready(function(){ 
         ...
         $("#banner_list .bannerbox:not(:first-child)").hide(); 
		 $("#banner_list .word,#banner_list .people").hide(); 
		 $(".bannerbox:first-child").find('.word').fadeIn(2000); 
		 $(".bannerbox:first-child").find('.people').fadeIn(3000); 
         $("#banner li").click(function() { 
          var i = $(this).text() - 1;//获取Li元素内的值，即1，2，3，4 
          n = i; 
          var wlen=$(".bannerbox").eq(i).find('.word').length;
		  var plen=$(".bannerbox").eq(i).find('.people').length;
		  if (i >= count) return; 
          $("#banner_list .bannerbox").filter(":visible").fadeOut(500).parent().children().eq(i).fadeIn(1500); 
		  if(wlen){
			  $(".bannerbox .word").hide();
			  $(".bannerbox").eq(i).find('.word').fadeIn(2500);  
		  }
		  if(plen){
			  $(".bannerbox .people").hide();
			  $(".bannerbox").eq(i).find('.people').fadeIn(3000); 
		  }
...
<div id="main">
        ...
        <div id="aside_middle">
            <div style="float:left;">
                <div class="navi_aside_focus" id="news_navi" onclick="change_news(this.id)">最新消息</div>
                <div class="navi_aside_blur" id="notify_navi" onclick="change_news(this.id)">最新通告</div>
                <div id="news_board" class="middle_board">
                    <div style="float:left;">
                        <div class="news"><img src="images/pointer.png"><a href="#">幼稚園K1至K3家長《優質家長講座》</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">幼稚園K1至K3家長《優質家長講座》</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">幼稚園K1至K3家長《優質家長講座》</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">幼稚園K1至K3家長《優質家長講座》</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">幼稚園K1至K3家長《優質家長講座》</a><div style="float:right;">21.09.2013</div></div>
                ...
                <div id="notify_board" class="middle_board" style="display:none;">
                    <div>
                        <div class="news"><img src="images/pointer.png"><a href="#">“重承诺，講誠信”標語創作活動參考資料</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">“重承诺，講誠信”標語創作活動參考資料</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">“重承诺，講誠信”標語創作活動參考資料</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">“重承诺，講誠信”標語創作活動參考資料</a><div style="float:right;">21.09.2013</div></div>
                        <div class="news"><img src="images/pointer.png"><a href="#">“重承诺，講誠信”標語創作活動參考資料</a><div style="float:right;">21.09.2013</div></div>
                ...
                <div id="photo_gallery">
                    ...
                    <div style="height:120px;border-radius:5px;float:left;width:100%;background:#f8f8f8;border:1px solid #e3e3e3;">
                        <img style="width:17px;margin-bottom:30px;margin-right:0px;" src="images/photo_left.png">
                        <img src="images/photo_01.png">
                        <img src="images/photo_02.png">
                        <img src="images/photo_03.png">
                        <img src="images/photo_04.png">
                        <img style="margin-right:0px;" src="images/photo_05.png">
                        <img style="width:17px;margin-bottom:30px;margin-right:0px;" src="images/photo_right.png">
                    </div>
                </div>
            </div>
        </div>
