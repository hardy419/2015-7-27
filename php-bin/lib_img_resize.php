...
function image_resize_lib( $upfile, $output_filename, $output_path, $dst_w=100, $dst_h=100, $isRadio=1, $trans_color=array(254, 254, 254) )
{
...
//echo '123<br>'.$output_path.$output_filename ;
	imagecopyresampled( $dst_image, $src_image, $re_dst_x, $re_dst_y, 0, 0, $re_dst_w, $re_dst_h, $src_w, $src_h );
	return imagepng( $dst_image, $output_path.$output_filename );
}
