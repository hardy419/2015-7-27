...
$search_SQL    = "SELECT    *    FROM     tbl_contest   WHERE  a_type=3 ";
...
if(0==$id){
	$rs=mysql_query( 'SELECT    *    FROM      tbl_contest   WHERE  a_type=3	ORDER BY  a_date  DESC 	LIMIT 1 ', $link_id );
      ...
      <div id="contents">
	     ...
	     <!-- locationGroup -->
	      <div id="locationGroup">
            <img src="images/title/student_scholarship.jpg" />
          ...
          <tr>
            <td  valign="top" bgcolor="#FEFAF5" width="200">
                         ...
                         $i=0;
							...
							<table width="200" border="0" cellpadding="0" cellspacing="0" <?php if($id==$Record_Obj->a_id){?> bgcolor="#FCEEDC"<?php }?> class="left_line">
				              <tr>
				                ...
				                <td height="30" class="left_line"><a href="GrowUp_Affair_scholarship.php?id=<?php echo $Record_Obj->a_id?>" target="_self"><?php echo $Record_Obj->a_title?></a></td>
				              </tr>
				              <tr>
				                <td>&nbsp;</td>
	                ...
	                <table border="0" width=200 cellspacing="0" cellpadding="0">
	                  <tr>
	                    <td align="right"><a href="GrowUp_Affair_scholarship_List.php"><img src="images/more.jpg" width="41" height="17" border="0" /></a></td>
