...
$search_SQL    = "SELECT    *    FROM     tbl_notice   WHERE  a_type='6' ";
...
if(0==$id){
	$rs=mysql_query( 'SELECT    *    FROM     tbl_notice   WHERE  a_type=6	ORDER BY   a_id  DESC 	LIMIT 1 ', $link_id );
	if($row=mysql_fetch_assoc($rs)){
		$id=$row['a_id'];
	}
}
$query="select * from tbl_notice  where a_id=$id limit 1";
      ...
      <div id="contents">
	     ...
	     <!-- locationGroup -->
	      <div id="locationGroup">
            <img src="images/title/info_Overseas.jpg" />
          ...
          <tr>
            <td  valign="top" bgcolor="#FEFAF5" width="200">
                         ...
                         $i=0;
							...
							<table width="200" border="0" cellpadding="0" cellspacing="0" <?php if($id==$Record_Obj->a_id){?> bgcolor="#FCEEDC"<?php }?> class="left_line">
				              <tr>
				                ...
				                <td height="30" class="left_line"><a href="About_Team_Word.php?id=<?php echo $Record_Obj->a_id?>" target="_self"><?php echo $Record_Obj->a_title?></a></td>
				              </tr>
				              <tr>
				                <td>&nbsp;</td>
	                ...
	                <table border="0" width=200 cellspacing="0" cellpadding="0">
	                  <tr>
	                    <td align="right"><a href="News_Overseas_List.php"><img src="images/more.jpg" width="41" height="17" border="0" /></a></td>
