...
$search_SQL    = "SELECT    *    FROM     tbl_notice   WHERE  a_type=3 ";
//echo $search_SQL;die();
...
if(0==$id){
	$rs=mysql_query( 'SELECT    *    FROM    tbl_notice   WHERE  a_type=3	ORDER BY   a_date  DESC 	LIMIT 1 ', $link_id );
...
$query="select * from tbl_notice  where a_id=$id";
          ...
          <tr>
            <td  valign="top" bgcolor="#FEFAF5" width="200">
                         ...
                         $i=0;
							...
							<table width="200" border="0" cellpadding="0" cellspacing="0" <?php if($id==$Record_Obj->a_id){?> bgcolor="#FCEEDC"<?php }?> class="left_line">
				              <tr>
				                ...
				                <td height="30" class="left_line"><a href="DownLoad_Invitation.php?id=<?php echo $Record_Obj->a_id?>" target="_self"><?php echo $Record_Obj->a_title?></a></td>
				              </tr>
				              <tr>
				                <td>&nbsp;</td>
	                ...
	                <table border="0" width=200 cellspacing="0" cellpadding="0">
	                  <tr>
	                    <td align="right"><a href="DownLoad_Invitation_List.php"><img src="images/more.jpg" width="41" height="17" border="0" /></a></td>
