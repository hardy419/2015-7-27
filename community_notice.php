...
<?php require_once('./model/community_notice_list_selection.php'); ?>
        ...
        <div class="left_side_content">
            <div class="left_side_content_in">
              <table width="176" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><a href="community_notice.php" target="_self"><img src="images/community_left_list_hover_03.jpg"/></a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><a href="community_homeschool.php" target="_self"><img src="images/community_left_list_07.jpg" /></a></td>
                </tr>
                <!--tr>
    ...
    <div class="right_side">
        <div class="right_side_top02">
          <table width="780" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left"><img src="images/community_right_top_44.jpg" /></td>
              <td align="right" class="12pxfont"><table border="0" cellspacing="0" cellpadding="0"  class="position email_hover">
                <tr>
                  ...
                  <td width="25" align="center">&gt;</td>
                  <td align="left" height="25">家長通告</td>
                </tr>
                <tr>
                  ...
                  <td width="25" align="center">&gt;</td>
                  <td align="left" height="20">Notices</td>
                </tr>
              </table></td>
            </tr>
          </table>
            ...
            <tr>
              ...
              <td width="127">
                <select name="year" size="1" id="select" style="width:100px;">
				  ...
				  <?php require_once('./php-bin/get_community_notice_date_selection.php');?>
