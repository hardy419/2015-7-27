...
$search_SQL    = "Select ta.*,tt.* FROM `tbl_lastest` AS ta left JOIN (select * from tbl_lastest_gallery group by act_id)  AS tt  ON ta.id=tt.act_id";
...
.photo_tbl .box{width:210px;height:160px; overflow:hidden;}
.photo_tbl img{border:0px;width:190px;height:120px;}
.photo_tbl a.img{border:5px #FFFF99 solid;overflow:hidden;display:block;width:190px;height:120px;}
.photo_tbl a.img:hover{border:5px #FF9900 solid;}
.photo_tbl li{float:left;width:210px;height:160px;overflow:hidden;}
.photo_tbl li a.link{float:left;width:210px;overflow:hidden; display:block; text-align:center;}
</style>
...
<div id="container">
      ...
      <div id="contents">
	     ...
	     <!-- locationGroup -->
	      <div id="locationGroup">
            <img src="images/title/student_Activity.jpg" />

            <ul class="location">
                <li>首頁 &gt;</li><li>學生成長&gt;</li><li>生命教育 &gt;</li><li>最近活動</li>
            </ul>
        </div>
	  <!-- //locationGroup -->
	  ...
	  <div id="contents_In">
          ...
          <tr>
			...
			?>
                    <li>
                      <a class="img" href="GrowUp_leftEdu_Activity_List.php?id=<?php echo $get_rows['id'];?>"><img  src="gallery_activity/web<?php echo $get_rows['ori_file_name'];?>" /></a>
                      <a class="link" href="GrowUp_leftEdu_Activity_List.php?id=<?php echo $get_rows['id'];?>"><?php echo sub_str($get_rows['name'],16);?></a>
