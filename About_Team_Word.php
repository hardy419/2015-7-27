...
$search_SQL    = "SELECT    *    FROM     tbl_chancellor   WHERE  file_type_id='9' ";
//echo $search_SQL;die();
...
if(0==$id){
	$rs=mysql_query( 'SELECT    *    FROM     tbl_chancellor   WHERE  file_type_id=9	ORDER BY   file_date  DESC 	LIMIT 1 ', $link_id );
...
$query="select * from tbl_chancellor  where file_id=$id";
...
$result = mysql_query($query, $link_id);
	...
	while ($object=mysql_fetch_object($result)){
		...
		$file_date=$object->file_date;
		$file_title=$object->file_title;
		$file_link_text=$object->file_link_text;
		$file_link_url=$object->file_link_url;
		$file_photo=$object->file_photo;
		$file_file_name=$object->file_file_name;
		$file_content=$object->file_content;
		$file_link_new_window=$object->file_link_new_window;
		// $file_content = ereg_replace("\n","<BR>",$file_content);
}
            ...
            <td  valign="top" bgcolor="#FEFAF5" width="200">
                      <?php
                         $i=0;
							...
							?>
							<table width="200" border="0" cellpadding="0" cellspacing="0" <?php if($id==$Record_Obj->file_id){?> bgcolor="#FCEEDC"<?php }?> class="left_line">
				              <tr>
				                <td width="10%" align="center"><img src="images/arrow.png" width="4" height="7" /></td>
				                <td height="30" class="left_line"><a href="About_Team_Word.php?id=<?php echo $Record_Obj->file_id?>" target="_self"><?php echo $Record_Obj->file_title?></a></td>
				              </tr>
				              <tr>
				                <td>&nbsp;</td>
				                <td height="30">(<?php echo $Record_Obj->file_date?>)</td>
				              </tr>
				            </table>
	                ...
	                <!--<table border="0" width=200 cellspacing="0" cellpadding="0">
	                  <tr>
	                    <td align="right"><a href="About_Team_Word_List.php"><img src="images/more.jpg" width="41" height="17" border="0" /></a></td>
