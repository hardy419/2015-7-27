...
<div id="content">
    ...
    <div class="right_side">
          ...
          <tr>
            ...
            <td align="right" class="12pxfont"><table border="0" cellspacing="0" cellpadding="0"  class="position email_hover">
              <tr>
                ...
                <td width="25" align="center">&gt;</td>
                <td align="left" height="25">學校發展計劃/報告</td>
              </tr>
              <tr>
                ...
                <td width="25" align="center">&gt;</td>
                <td align="left" height="20">Plans and Reports</td>
              </tr>
            </table></td>
          </tr>
        </table>
      ...
      <div class="right_content">
				...
				<td colspan='2' align='right'>
					<div style='float:left;'>
						...
						<select name="document_type" id="document_type">
							  ...
							  <option value="4" <? if ($_GET["document_type"]=="4") { echo "selected"; } ?>>週年計劃</option>
							  ...
							  <option value="7" <? if ($_GET["document_type"]=="7") { echo "selected"; } ?>>其他</option>
						</select>
						<input name="Submit" type="submit" class="small" value="搜尋">
						</form>
					</div>
					<?php show_get_back('index.php','返回首頁'); ?>
					<!--?php show_post_mail('學校發展計劃/報告'); ?-->
				</td>
			</tr>
		</table>
          <table width="745" border="0" cellspacing="1" cellpadding="10" bgcolor="#B4B4B4" style="margin-top:30px;" class="email_hover">
            <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					  ...
					  <?php if(!empty($rel_arr_news['docoment_name'])){?>
						<td align="left">
							<a target="_blank" href='./userUpload/attachment/<?php echo $rel_arr_news['docoment_name'];?>'>
								<?php echo $rel_arr_news['title_cn'];?>
							</a>
						</td>
					  <?php }else{?>
						<td align="left">
							<a target="_blank" href='javascript:void(0);' alt='暫無內容瀏覽'>
								<?php echo $rel_arr_news['title_cn'];?>
							</a>
						</td>
					  <?php }?>
		  ...
		  <?php 
				$search_arr=array('document_type'=>$_GET["document_type"]);
