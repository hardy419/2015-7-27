                ...
                <tr>
                  <td colspan="2"><table width="635" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td width="78" <?php echo $class;?>><?php echo $Record_Obj->date?></td>
                        <td width="540" <?php echo $class;?>><a href="News_Video.php?id=<?php echo $Record_Obj->id?>"><?php echo $Record_Obj->name?></a> </td>
                      </tr>
                      <?php } ?>
                  </table></td>
                </tr>
