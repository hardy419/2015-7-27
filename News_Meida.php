...
if(0==$id){
	$rs=mysql_query( 'SELECT    *    FROM     tbl_notice   WHERE  a_type=5	ORDER BY   a_id  DESC 	LIMIT 1 ', $link_id );
      ...
      <div id="contents">
	     ...
	     <!-- locationGroup -->
	      <div id="locationGroup">
            <img src="images/title/info_Meida.jpg" />
          ...
          <tr>
            <td  valign="top" bgcolor="#FEFAF5" width="200">
	                ...
	                <table border="0" width=200 cellspacing="0" cellpadding="0">
	                  <tr>
	                    <td align="right"><a href="News_Meida_List.php"><img src="images/more.jpg" width="41" height="17" border="0" /></a></td>
